...
contains
  ...
  !############################################################################
  subroutine x3d_transpose_x_to_y_real(data_in, data_out, opt_decomp)
    ...
    if (p_row == 1) then
       ...
       if (present(opt_decomp)) then
          call transpose_x_to_y(data_in,data_out,opt_decomp)
       else
  ...
  !############################################################################
  subroutine x3d_transpose_x_to_y_cplx(data_in, data_out, opt_decomp)
  ...
  !!              single core calculation
  !############################################################################
  subroutine x3d_transpose_y_to_z_real(data_in, data_out, opt_decomp)
    ...
    if (p_col == 1) then
       ...
       if (present(opt_decomp)) then
          call transpose_y_to_z(data_in,data_out,opt_decomp)
       else
  ...
  !############################################################################
  subroutine x3d_transpose_y_to_z_cplx(data_in, data_out, opt_decomp)
  ...
  !!              single core calculation
  !############################################################################
  subroutine x3d_transpose_z_to_y_real(data_in, data_out, opt_decomp)
    ...
    if (p_col == 1) then
       ...
       if (present(opt_decomp)) then
          call transpose_z_to_y(data_in,data_out,opt_decomp)
       else
  ...
  !############################################################################
  subroutine x3d_transpose_z_to_y_cplx(data_in, data_out, opt_decomp)
  ...
  !!              single core calculation
  !############################################################################
  subroutine x3d_transpose_y_to_x_real(data_in, data_out, opt_decomp)
    ...
    if (p_row == 1) then
       ...
       if (present(opt_decomp)) then
          call transpose_y_to_x(data_in,data_out,opt_decomp)
       else
  ...
  !############################################################################
  subroutine x3d_transpose_y_to_x_cplx(data_in, data_out, opt_decomp)
